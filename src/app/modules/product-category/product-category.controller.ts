...
export class ProductCategoryController {
    ...
    static getCategoryListByAdmin = catchAsync(async (req, res) => {
        ...
        sendResponse(res, {
            statusCode: HttpStatusCode.Ok,
            success: true,
            message: 'Product category list get successfully',
            data: dataList,
        });
    });
    ...
    static getOnlyMainCategoryListByPublic = catchAsync(async (req, res) => {
        const dataList =
            await ProductCategoryService.findProductMainCategoryListFromDB();
        sendResponse(res, {
            statusCode: HttpStatusCode.Ok,
            success: true,
            message: 'Product category list get successfully',
